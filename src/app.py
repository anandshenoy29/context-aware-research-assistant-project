...
st.set_page_config(page_title="Context-Aware Research Assistant", page_icon="../assets/logo.png", layout="centered")
...
with st.sidebar:
    ...
    uploaded_file = st.file_uploader("Upload your PDF Document", type="pdf", disabled=st.session_state.processing)
...
if uploaded_file and st.session_state.agent_executor is None and not st.session_state.processing:
    st.session_state.processing = True
    st.rerun()

if st.session_state.processing and st.session_state.agent_executor is None and uploaded_file:
...
input_disabled = st.session_state.processing or st.session_state.agent_executor is None
    ...
    if last_message["role"] == "user":
        ...
        with st.chat_message("assistant", avatar="🤖"):
            with st.spinner("Thinking... 💭"):
                try:
                    response = st.session_state.agent_executor.invoke({"input": last_message["content"]})
