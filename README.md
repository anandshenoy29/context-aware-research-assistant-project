...
* Required Python libraries (`streamlit`, `python-dotenv`, `pypdf`, `ddgs`, `langchain-google-genai`, `langchain` and other LangChain libraries)
* An active Google Gemini API Key (stored securely in a .env file)

Execute the following commands in the Terminal (PowerShell) to set up your virtual environment and install the required packages:
...
<div align="center">
  <a href="https://docs.google.com/videos/d/1DlBPZUxRHy5TKDXwEn0D8idqtOU0I-mbR2JwVh5PE8E/edit?usp=sharing">
